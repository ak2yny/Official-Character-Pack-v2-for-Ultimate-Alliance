...
setCurrentAct(1 )
# ( "All town center objectives should be shown here." )
# ( "************************" )
...
# ( "This is set so that an intro conversation is only done once" )
...
# ( "Stark_Obj60:  The player has found the cufflinks" )
...
# ( "The actual game var is conv_vars bit 25, which is only set to 1 if the player chose Gabriel Jones as the password" )
password = randomInt(0, 1 )
# ( "This sets the value equal to 1 or 0" )
setGameFlag("conv_vars", 25, password )
# ( "************************" )
# ( "The following objectives shown have already been completed" )
