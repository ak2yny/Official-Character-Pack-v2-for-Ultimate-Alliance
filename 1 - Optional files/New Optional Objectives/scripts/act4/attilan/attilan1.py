...
addObjectiveCategory("act4_attilan" )
addObjectiveCategory("act4_shiar" )
addObjectiveCategory("act4_astral" )
addObjectiveCategory("act4_skrull" )
# ( "****************END Unlock the objective categories****************" )
cameraSetClipPlane(10000.000 )
objective ( "attilan_obj0",  "EOBJCMD_SHOW" )
objective ( "attilan_obj10",  "EOBJCMD_SHOW" )
objective ( "attilan_obj30",  "EOBJCMD_SHOW" )
objective ( "attilan_obj40",  "EOBJCMD_SHOW" )
