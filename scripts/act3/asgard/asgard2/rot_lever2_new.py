...
copyOriginAndAngles("_ACTIVATOR_", "lev2_null" )
playanim (  "EA_ZONE3", "_ACTIVATOR_", "NONE", "" )
act("rot_lever2", "rot_lever2" )
waittimed ( 1.000 )
cameraFocusToEntity("cam_statue2", 512.000, 35.000, 0.000, 1.000 )
waittimed ( 1.000 )
act("rot_statue2", "rot_statue2" )
# ( "Math to set ZoneVar to current rotation" )
rotation2 = getZoneVar("statue2" )
newrotation = iadd(rotation2, 1 )
...
if newrotation == 4
     setZoneVar("statue2", 0 )
else
     setZoneVar("statue2", newrotation )
endif
