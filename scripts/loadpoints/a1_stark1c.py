...
# ( "Stark_Obj30: The decryption module has not been given to Vision and the player needs to talk to Black Widow to get it" )
setGameFlag("conv_vars", 5, 1 )
# ( "Stark_Obj40: The Ultimo Schematics were found in Mandarin and given to Fury" )
